...
function isStockout(loc) {
    return loc.attr('inj') == '0' || loc.attr('pop') == '0' || loc.attr('imp') == '0' || loc.attr('con') == '0' || loc.attr('coc') == '0' || loc.attr('iud') == '0';  
};
        ...
        jQuery("ul.labels > li", this).each(function() {
            ...
            if(lat && lng) {
                ...
                var contentString = '<div id="content">'+
                    ...
                    '</h4>'+
                    '<div id="bodyContent">'+
                    formatInventory(loc.attr('inj'),'Injectables')+
                    formatInventory(loc.attr('pop'),'Progesterone')+
                    formatInventory(loc.attr('coc'),'Combined Oral Therapy')+
                    formatInventory(loc.attr('iud'),'IUD')+
                    formatInventory(loc.attr('con'),'Condoms')+
                    formatInventory(loc.attr('imp'),'Implants')+
                    '<i>Last reported '+ loc.attr("last_reported") +'</i>'+
                    '</div>'+
                    '</div>';
